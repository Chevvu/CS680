...
public class Directory extends FSElement{
    ...
    public LinkedList<FSElement> getChildren() {
        Collections.sort(children, (FSElement fs1, FSElement fs2)->fs1.getName().compareTo(fs2.getName()));
        return children;
    }
    ...
    public LinkedList<Directory> getSubDirectories(){
        ...
        Collections.sort(SubDirectories, (FSElement fs1, FSElement fs2)->fs1.getName().compareTo(fs2.getName()));
    ...
    public LinkedList<File> getFiles(){
        ...
        Collections.sort(files, (FSElement fs1, FSElement fs2)->fs1.getName().compareTo(fs2.getName()));
        return files;
    }
